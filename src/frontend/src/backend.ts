...
export class Backend implements backendInterface {
    ...
    async getAllContacts(): Promise<Array<PersistentContact>> {
        if (this.processError) {
            try {
    ...
    async getContact(arg0: bigint): Promise<PersistentContact> {
        if (this.processError) {
            try {
    ...
    async saveContact(arg0: ContactForm): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveContact(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
